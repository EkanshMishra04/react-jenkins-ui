...
import { GET_ALL_JENKINS_JOBS } from '../../constants/UrlConstants';
import { GET_FAILURE } from '../../constants/Constants';


const GetByNamespace = () => {
    ...
    const getDataFromApi = () => {
        axios.get(`${GET_ALL_JENKINS_JOBS}`+namespace)
          .then((response) => {
    ...
    return (
        <div className='main-container'>
            <div className="classA"><h4>Default</h4></div>
            <div className='classB'>
                <div classname="classB1"><UrlComponent method="GET" uri="/pods/{namespace}" detail="List jenkins instances" /></div>
                <div classname="classB2">
                    ...
                    <div className='main-container-parameter'>
                        ...
                        <div className='paramC'>
                            <button className='col-lg-5 btn btn-primary' onClick={() => getDataFromApi()}>Execute</button>
                ...
                <div>
                    {
                        isError? <Responses data={error} />:<Responses data={pods} />
                    }
                </div>
            </div>
        </div>
